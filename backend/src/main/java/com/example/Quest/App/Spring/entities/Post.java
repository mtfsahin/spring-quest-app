...
//This class create "Post" table for Post process
public class Post {
	...
	//Actually here, it connects to then user table of the user_id in the post table, nullable = false because i don't want it to be null object 
